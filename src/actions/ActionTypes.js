...
export const AUTH_LOGIN_FAILIURE = "AUTH_LOGIN_FAILIURE";
...
export const MEMO_START = "MEMO_START";
export const MEMO_START_SUCCESS = "MEMO_START_SUCCESS";
export const MEMO_START_FAILURE = "MEMO_START_FAILURE";